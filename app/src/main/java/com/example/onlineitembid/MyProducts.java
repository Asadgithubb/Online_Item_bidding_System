...
import com.example.onlineitembid.Adapter.ProductAdapter;
import com.example.onlineitembid.Model.ProductModel;
import com.example.onlineitembid.Model.userModel;
...
public class MyProducts extends AppCompatActivity {
    ...
    private long countdownTimeInMillis = 300000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_showOrders.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyProducts.this, ShowAllBiders.class);
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(RegistrationActivity.RIDER_USERS).child(userId);
    ...
    private void createFood(String foodName, String foodDesc, String foodPrice, String username, String foodImage, String phoneNumber) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(RegistrationActivity.RESTAURANT_FOOD).child(userId);
        HashMap<String, Object> hashMap = new HashMap<>(); // Change the type to Object
        ...
        hashMap.put("isApproved", false); // Set the initial status to false
        hashMap.put("bidder", "");
        hashMap.put("bid", "");
