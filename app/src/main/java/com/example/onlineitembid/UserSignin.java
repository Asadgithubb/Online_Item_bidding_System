...
import com.example.onlineitembid.Admin.Adminpage;
...
public class UserSignin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_registerBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UserSignin.this, RegistrationActivity.class));
            }
        });
    }
    ...
    private void performLogin() {
        ...
        if (email.isEmpty()) {
            ...
            if (username.equals("UOE") && email.equals("admin1234@gmail.com") && password.equals("admin1234")) {
    ...
    private void sendUserToAdminMain() {
        Intent adminIntent = new Intent(UserSignin.this, Adminpage.class);
